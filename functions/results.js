...
x.innerHTML = "X"
x.onclick = "this.parentNode.removeChild(this)"
...
var row = document.createElementId('tr')
...
</script><body><div id="pseudo_form_accounts">
...
<button onclick="updateProducts('products_table','add')">Add</button>
</div>
...
<h1 class="table_heading">Accounts</h1>
